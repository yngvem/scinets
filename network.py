...
class NeuralNet:
    def __init__(self, x, architecture, is_training=None, verbose=False):
        ...
        self.is_training = tf.placeholder(tf.bool, [1]) if is_training is None else is_training

        self.out, self.params = self.assemble_network()
...
if __name__ == '__main__':
    ...
    y, params = network(x, architecture, is_training, verbose=True)
